    ...
    <div class="-mx-4 flex flex-wrap items-center">
      <div class="w-full px-3 lg:w-1/2">
        <div class="mx-auto mb-12 max-w-[530px] text-center lg:ml-1 lg:mb-0 lg:text-left">
          ...
          <h1 class="wow
            fadeInUp mb-5 font-heading text-2xl font-semibold dark:text-white sm:text-4xl md:text-[500px] md:leading-[60px]" data-wow-delay=".3s"> {{__("Ignite Your Creativity with ")}}
            <span class="txt-type" data-wait="3000" data-words='<?php echo $typingKeywords?>'></span>
          </h1>
          <p class="mb-12 text-base text-dark-text" data-wow-delay=".4s"> {{__("Our AI-powered content generator platform helps you create engaging blog posts, website copy, social media content, and more. Simply provide a few details and let our AI do the heavy lifting.")}}</p>
        ...
        <div class="wow fadeInRight relative z-30 mx-auto h-[560px] w-full max-w-[700px] lg:ml-0" data-wow-delay=".3s">
          <div class="absolute cs-video-block right-0 z-10">
            <video autoplay muted loop>
              <source src="{{ asset('assets/landing/video/intro.mp4') }}" type="video/mp4">
            </video>
