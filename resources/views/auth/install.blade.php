      ...
      <div class="row">
          ...
          <div class="col-12 col-lg-6">
            <div class="card card-primary">
             <div class="card-header bg-white"><h4 class="mt-2"><i class="far fa-check-circle"></i> Installation | <a style="color:red;" href="https://weadown.com" target="_blank">weadown.com</a></h4></div>
