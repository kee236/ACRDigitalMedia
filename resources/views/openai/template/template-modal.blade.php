            ...
            <div class="modal-body p-4" id="">
               ...
               <div class="col-12 prompt_related_container">
                    <div class="form-group">
                        ...
                        <small style="font-size: 10px"><?php echo __('Example: Write a blog on :about by targeting :target-keyword keyword.',['about'=>'{{about}}','target-keyword'=>'{{target-keyword}}']); ?></small>
                    </div>
                </div>
