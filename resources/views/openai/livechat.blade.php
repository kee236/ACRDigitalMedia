...
<div class="light-mode" id="frame">
    ...
    <div class="content">
        ...
        <div class="input-group mx-4" id="sendblock">
            <textarea type="text" class="form-control border-1 mt-3" id="send_message" placeholder="{{ __('Start typing your mind...')}}"></textarea>  
            <div class="input-group-append cursor-pointer border-0 mt-3" id="final_send_button">
                <span class="input-group-text border-0" id="final_send_span"><i class="fa fa-paper-plane"></i></span>
            </div>                                                 
        </div>
